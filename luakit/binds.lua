...
menu_binds = {
    -- Navigate items
    key({"Control"}, "n",       function (w) w.menu:move_down() end),
    key({"Control"}, "p",       function (w) w.menu:move_up()   end),

    key({"Control"}, "т",       function (w) w.menu:move_down() end),
    key({"Control"}, "з",       function (w) w.menu:move_up()   end),
...
add_binds("all", {
    ...
    key({"Control"}, "х",       function (w) w:set_mode() end),
...
add_binds("normal", {
    ...
    key({},          "ш",           function (w) w:set_mode("insert")  end),
    key({},          "Ж",           function (w) w:set_mode("command") end),

    -- Scrolling
    key({"Control"}, "n",           function (w) w:scroll_vert(more)  end),
    key({"Control"}, "p",           function (w) w:scroll_vert(less)  end),
    key({"Control"}, "b",           function (w) w:scroll_horiz(less) end),
    key({"Control"}, "f",           function (w) w:scroll_horiz(more) end),

    key({"Control"}, "т",           function (w) w:scroll_vert(more)  end),
    key({"Control"}, "з",           function (w) w:scroll_vert(less)  end),
    key({"Control"}, "и",           function (w) w:scroll_horiz(less) end),
    key({"Control"}, "а",           function (w) w:scroll_horiz(more) end),
    ...
    key({"Control"}, "у",           function (w) w:scroll_vert(more)  end),
    key({"Control"}, "н",           function (w) w:scroll_vert(less)  end),
    key({"Control"}, "в",           function (w) w:scroll_page(0.5)   end),
    key({"Control"}, "г",           function (w) w:scroll_page(-0.5)  end),
    key({"Control"}, "а",           function (w) w:scroll_page(1.0)   end),
    key({"Control"}, "и",           function (w) w:scroll_page(-1.0)  end),
    ...
    key({"Control"}, "v",           function (w) w:scroll_page(0.93)   end),
    key({"Mod1"},    "v",           function (w) w:scroll_page(-0.93)  end),

    key({"Control"}, "м",           function (w) w:scroll_page(0.93)   end),
    key({"Mod1"},    "м",           function (w) w:scroll_page(-0.93)  end),

    key({"Shift","Mod1"}, "<",           function (w) w:scroll_vert("0%") end),
    key({"Shift","Mod1"}, ">",           function (w) w:scroll_vert("100%") end),

    key({"Shift","Mod1"}, "Б",           function (w) w:scroll_vert("0%") end),
    key({"Shift","Mod1"}, "Ю",           function (w) w:scroll_vert("100%") end),
    ...
    buf("^пп$",                     function (w, b, m) w:scroll_vert(m.count.."%") end, {count = 0}),
    buf("^П$",                      function (w, b, m) w:scroll_vert(m.count.."%") end, {count = 100}),
    ...
    key({"Control"}, "ф",           function (w)    w:navigate(w:inc_uri(1)) end),
    key({"Control"}, "ч",           function (w)    w:navigate(w:inc_uri(-1)) end),
    buf("^щ$",                      function (w, c) w:enter_cmd(":open ")    end),
    buf("^е$",                      function (w, c) w:enter_cmd(":tabopen ") end),
    buf("^ц$",                      function (w, c) w:enter_cmd(":winopen ") end),
    buf("^Щ$",                      function (w, c) w:enter_cmd(":open "    .. (w:get_current().uri or "")) end),
    buf("^Е$",                      function (w, c) w:enter_cmd(":tabopen " .. (w:get_current().uri or "")) end),
    buf("^Ц$",                      function (w, c) w:enter_cmd(":winopen " .. (w:get_current().uri or "")) end),
    buf("^бп$",                     function (w, c) w:enter_cmd(":open google ") end),
    ...
    key({},          "Р",           function (w, m) w:back(m.count)    end),
    key({},          "Д",           function (w, m) w:forward(m.count) end),
    key({},          "и",           function (w, m) w:back(m.count)    end),

    key({},          "XF86Back",    function (w, m) w:back(m.count)    end),
    key({},          "XF86Forward", function (w, m) w:forward(m.count) end),

    key({"Control"}, "щ",           function (w, m) w:back(m.count)    end),
    key({"Control"}, "ш",           function (w, m) w:forward(m.count) end),
    ...
    buf("^пЕ$",                     function (w, b, m) w:prev_tab(m.count) end, {count=1}),
    buf("^пе$",                     function (w, b, m) if not w:goto_tab(m.count) then w:next_tab() end end, {count=0}),
    ...
    key({"Control"}, "е",           function (w)    w:new_tab(homepage) end),
    key({"Control"}, "ц",           function (w)    w:close_tab()       end),
    key({},          "в",           function (w, m) for i=1,m.count do w:close_tab()      end end, {count=1}),

    key({},          "Ю",           function (w, m) w.tabs:reorder(w:get_current(), w.tabs:current() - m.count) end, {count=1}),
    key({},          "Б",           function (w, m) w.tabs:reorder(w:get_current(), (w.tabs:current() + m.count) % w.tabs:count()) end, {count=1}),
    ...
    buf("^пР$",                     function (w, b, m) for i=1,m.count do w:new_tab(homepage) end end, {count=1}),
    buf("^пр$",                     function (w)       w:navigate(homepage) end),

    -- Open tab from current tab history
    buf("^gy$",                     function (w) w:new_tab(w:get_current().history or "") end),

    buf("^пн$",                     function (w) w:new_tab(w:get_current().history or "") end),
    ...
    key({},          "к",           function (w) w:reload() end),
    key({},          "К",           function (w) w:reload(true) end),
    key({"Control"}, "с",           function (w) w:stop() end),

    -- Config reloading
    key({"Control", "Shift"}, "R",  function (w) w:restart() end),

    key({"Control", "Shift"}, "К",  function (w) w:restart() end),
    ...
    buf("^ЯЯ$",                     function (w) w:save_session() w:close_win() end),
    buf("^ЯЙ$",                     function (w) w:close_win() end),
    buf("^В$",                      function (w) w:close_win() end),

    -- Enter passthrough mode
    key({"Control"}, "z",           function (w) w:set_mode("passthrough") end),
    key({"Control"}, "я",           function (w) w:set_mode("passthrough") end),
})
...
add_binds({"command", "search"}, {
    ...
    key({"Control"}, "ц",       function (w) w:del_word() end),
    key({"Control"}, "г",       function (w) w:del_line() end),
    key({"Control"}, "р",       function (w) w:del_backward_char() end),
    key({"Control"}, "в",       function (w) w:del_forward_char() end),
    key({"Control"}, "ф",       function (w) w:beg_line() end),
    key({"Control"}, "у",       function (w) w:end_line() end),
    key({"Control"}, "а",       function (w) w:forward_char() end),
    key({"Control"}, "и",       function (w) w:backward_char() end),
    key({"Mod1"},    "а",       function (w) w:forward_word() end),
    key({"Mod1"},    "и",       function (w) w:backward_word() end),
